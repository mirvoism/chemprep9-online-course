...
export const c7l1Enhanced: Lesson = {
  ...
  interactive: [
    ...
    {
      type: 'custom',
      title: 'Solubility Curve Analyzer',
      description:
        'Interactive tool for interpreting solubility data and predicting solution behavior at different temperatures.',
      placeholderText:
        '**Learning Goal:** Master solubility curve interpretation and solution classification.\n\n**Functionality:** Students input temperature and solute amount to determine if solutions are saturated, unsaturated, or supersaturated. Interactive graphs show solubility curves for common substances. Temperature sliders demonstrate how heating/cooling affects solubility.\n\n*Builds understanding of dynamic equilibrium in solution chemistry.*',
    },
    {
      type: 'custom',
      title: 'Solution Concentration Calculator',
      description:
        'Comprehensive tool for concentration calculations including molarity, molality, and parts per million.',
      placeholderText:
        '**Learning Goal:** Convert between concentration units and understand their applications.\n\n**Functionality:** Students practice dilution calculations, unit conversions, and solution preparation procedures. Visual representations show molecular-level concentration differences. Includes real-world examples from environmental and medical chemistry.\n\n*Connects mathematical calculations to practical applications.*',
    },
    {
      type: 'custom',
      title: 'Calorimetry Lab Simulator',
      description:
        'Virtual calorimeter for measuring heat changes in chemical and physical processes.',
      placeholderText:
        '**Learning Goal:** Apply thermochemical principles to quantify energy changes.\n\n**Functionality:** Students conduct virtual calorimetry experiments measuring temperature changes, calculating specific heats, and determining enthalpy changes. Includes phase change experiments and chemical reaction calorimetry.\n\n*Provides hands-on experience with energy measurement techniques.*',
    },
    {
      type: 'custom',
      title: 'Colligative Properties Explorer',
      description:
        'Interactive model demonstrating how solute particles affect solution properties.',
      placeholderText:
        '**Learning Goal:** Understand particle-dependent solution behaviors.\n\n**Functionality:** Students observe how adding different amounts and types of solutes affects freezing point, boiling point, and vapor pressure. Animations show molecular-level explanations for macroscopic property changes.\n\n*Visualizes abstract concepts through observable property changes.*',
    },
  ],
