...
export const c6l1Enhanced: Lesson = {
  ...
  interactive: [
    ...
    },
    {
      ...
      description:
        'Interactive tool for solving gas law problems with step-by-step dimensional analysis.',
      placeholderText:
        '**Learning Goal:** Master gas law calculations and understand P-V-T relationships.\n\n**Functionality:** Students select which gas law to use (Boyle\'s, Charles\'s, Gay-Lussac\'s, or Combined) and input known variables. The calculator shows the setup, unit conversions (especially Celsius to Kelvin), and step-by-step solution. Visual graphs demonstrate the relationships.\n\n*Builds confidence in mathematical problem-solving with real-world gas scenarios.*',
    },
    {
      type: 'custom',
      title: 'Phase Change Energy Calculator',
      description:
        'Calculate energy requirements for melting, boiling, and cooling using specific heats and enthalpies.',
      placeholderText:
        '**Learning Goal:** Quantify energy changes during phase transitions.\n\n**Functionality:** Students input mass, temperature changes, and substances to calculate heating/cooling energy requirements. Includes both sensible heat (q = mcΔT) and latent heat (q = mΔH) calculations. Interactive heating curves show energy distribution.\n\n*Connects molecular behavior to thermodynamic calculations.*',
    },
    {
      type: 'custom',
      title: 'Kinetic Molecular Theory Visualizer',
      description:
        'Interactive model showing particle motion, spacing, and energy distribution in different phases.',
      placeholderText:
        '**Learning Goal:** Visualize molecular-level behavior across physical states.\n\n**Functionality:** Animated particles show motion patterns for solids (vibration), liquids (flow), and gases (random motion). Temperature slider affects particle speed. Intermolecular force indicators show attraction strength between particles.\n\n*Makes abstract molecular theory concrete and observable.*',
    },
  ],
