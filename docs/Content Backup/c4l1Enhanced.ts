...
export const c4l1Enhanced: Lesson = {
  ...
  interactive: [
    ...
    {
      type: 'custom',
      url: '/simulations/bonding-basics',
      title: 'Bonding Basics',
      description: 'Interactive tutorial on ionic, covalent, and metallic bonding fundamentals.',
    },
    {
      type: 'custom',
      url: '/tools/electronegativity-trends',
      title: 'Electronegativity Trends',
      description: 'Interactive periodic table showing electronegativity values and trends.',
    },
  ],
  narrative: `# UNIT 4: Chemical Bonding: Molecular Architecture and Properties

### **Chemical Bonding: The Forces That Hold Matter Together**

Chemical bonding represents the attractive forces that hold atoms together in compounds, determining everything from a material's melting point to its electrical conductivity${citationInline('brown-chemistry-14th', 1)}. Understanding bonding enables us to predict molecular shapes, explain why oil and water don't mix, and design materials with specific properties for technological applications.

The **electronegativity difference** between bonding atoms serves as our primary tool for predicting bond type${citationInline('pauling-electronegativity', 2)}. Electronegativity measures an atom's ability to attract shared electrons, with fluorine being the most electronegative element (4.0) and francium the least (0.7).

### **Ionic Bonding: Complete Electron Transfer**

**Ionic bonding** occurs when electrons transfer completely from metal atoms to nonmetal atoms, creating charged ions held together by electrostatic attraction${citationInline('lattice-energy-data', 3)}. This bonding type typically occurs when the electronegativity difference exceeds 1.7.
...
- **Brittleness**: Crystal structure fractures when layers shift${citationInline('ionic-crystal-structure', 4)}

### **Covalent Bonding: Electron Sharing for Stability**

**Covalent bonding** involves electron sharing between nonmetal atoms to achieve stable electron configurations${citationInline('lewis-structure-theory', 5)}. The shared electrons are attracted to the nuclei of both atoms, creating the bond that holds them together.
...
### **Molecular Polarity: Unequal Sharing and Its Consequences**

Not all covalent bonds involve equal electron sharing. **Electronegativity differences** create bond polarity, which combines with molecular geometry to determine overall molecular polarity${citationInline('pauling-electronegativity', 17)}.
...
- **Ionic character** (ΔEN > 1.7): Essentially complete electron transfer${citationInline('nist-electronegativity-data', 18)}
...
3. **Assess vector cancellation** of individual bond dipoles${citationInline('gillespie-vsepr', 19)}
...
- **Lone pairs occupy more space** than bonding pairs, affecting bond angles${citationInline('molecular-geometry-data', 20)}
...
**Metallic bonding** occurs between metal atoms through the "electron sea model"${citationInline('ashcroft-solid-state', 21)}. Metal atoms contribute their valence electrons to a delocalized electron cloud that moves freely throughout the crystal structure.
...
- **Non-directional bonding** allows atoms to pack efficiently${citationInline('kittel-solid-state', 22)}
...
- **Metallic luster**: Mobile electrons interact with light waves${citationInline('nist-electrical-properties', 23)}

### **Intermolecular Forces: Attractions Between Molecules**

While intramolecular forces (chemical bonds) hold atoms together within molecules, **intermolecular forces (IMFs)** act between separate molecules${citationInline('materials-science-metals', 24)}. These weaker forces significantly influence physical properties like boiling point, viscosity, and solubility.
...
- **Strength increases** with molecular size and surface area${citationInline('london-dispersion-theory', 25)}
...
- **Only occurs** between polar molecules${citationInline('dipole-interaction-data', 26)}
...
- **Network formation** in substances like water and DNA${citationInline('hydrogen-bond-database', 27)}

### **Structure-Property Relationships: Connecting Bonding to Observable Behavior**

Understanding bonding types and intermolecular forces enables prediction of physical and chemical properties${citationInline('solubility-theory', 28)}:
...
- **Hydrogen bonding**: Enhances solubility in water${citationInline('electronegativity-scales', 29)}
...
- **Network covalent**: Very hard (extensive covalent bonding)${citationInline('materials-properties-database', 30)}
