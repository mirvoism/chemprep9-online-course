...
<div class="my-4 flex flex-wrap justify-around items-center gap-4">
  <svg width="180" height="120" xmlns="http://www.w3.org/2000/svg" aria-label="Helium atoms representing an element" class="inline-block p-2 border border-border-color rounded bg-card-bg dark:bg-slate-700">
  ...
  <svg width="240" height="120" xmlns="http://www.w3.org/2000/svg" aria-label="Oxygen molecules representing a diatomic element" class="inline-block p-2 border border-border-color rounded bg-card-bg dark:bg-slate-700">
...
<div class="my-4 flex justify-center">
  <svg width="200" height="120" xmlns="http://www.w3.org/2000/svg" aria-label="Water molecules representing a compound" class="inline-block p-2 border border-border-color rounded bg-card-bg dark:bg-slate-700">
    <symbol id="waterMolecule" viewBox="-6 -6 12 12">
      <circle cx="0" cy="0" r="3" fill="var(--color-danger)" />
      <text x="-1.5" y="1" font-size="4" fill="var(--color-text-light)" class="font-bold">O</text>
      <circle cx="-4" cy="4" r="2" fill="var(--color-secondary)" />
      <text x="-5" y="5" font-size="3" fill="var(--color-text-light)">H</text>
      <circle cx="4" cy="4" r="2" fill="var(--color-secondary)" />
      <text x="3" y="5" font-size="3" fill="var(--color-text-light)">H</text>
      <line x1="0" y1="0" x2="-3" y2="3" stroke="var(--color-text-light)" stroke-width="1"/>
      <line x1="0" y1="0" x2="3" y2="3" stroke="var(--color-text-light)" stroke-width="1"/>
    </symbol>
...
<div class="my-4 flex justify-center">
  <svg width="220" height="150" xmlns="http://www.w3.org/2000/svg" aria-label="Sand and water representing a heterogeneous mixture" class="inline-block p-2 border border-border-color rounded bg-card-bg dark:bg-slate-700">
    <!-- Water layer -->
    ...
    <text x="20" y="140" font-size="12" fill="var(--color-text-muted)" class="font-semibold">Heterogeneous Mixture: Sand <text x="40" y="140" font-size="12" fill="var(--color-text-muted)" class="font-semibold">Heterogeneous Mixture: Sand & Water</text> Water</text>
  </svg>
</div>
